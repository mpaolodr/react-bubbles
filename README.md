...
- [x] Explain what a token is used for.
  ...
  token is used to verify whether the user is authorized to access pages in a webpage

- [x] What steps can you take in your web apps to keep your data secure?

  setup authentication process to verify credentials being passed by user

- [x] Describe how web servers work.

  when a user tries to visit a website, it sends information to the modem which will be passed to ISP and then it will
  try to locate the location and retrieve information from the server
